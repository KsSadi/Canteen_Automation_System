                ...
                <tr class="intro-x">
                    ...
                    <td style="text-align: center">
                        <div class="flex justify-center items-center" >
                            ...
                            <a class="flex items-center text-theme-6" href="{{ route('dashboard.employees.destroy', $employee->id) }}" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $employee->id }}').submit()">
                            ...
                            <form id="delete-form-{{$employee->id}}" action="{{ route('dashboard.employees.destroy', $employee->id) }}" method="POST" style="display: none">
                                @method('DELETE')
                                @csrf
                            </form>
                        </div>
