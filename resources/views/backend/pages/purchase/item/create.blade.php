...
@section('admin-section')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('dashboard.purchase.item.store') }}" method="POST">
                @csrf
                <div class="row" style="">
                    <div class="mb-1 row">
                    ...
                    <div class="mb-1 row">
                        ...
                        <div class="col-sm-10">
                            <select class="select2 form-select" id="select2-basic" name="pcat_id" required>
                    ...
                    <div class="mb-1 row">
                        ...
                        <div class="col-sm-10">
                            <select class="select2 form-select" id="select2-basic" name="punit_id" required>
                                <option value="">Select</option>
